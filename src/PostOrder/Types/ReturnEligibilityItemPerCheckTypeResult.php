...
/**
 *
 * @property EligibilityCheckTypeEnum $checkType
 * @property EligibilityResultType $eligibilityInfo
 */
class ReturnEligibilityItemPerCheckTypeResult extends BaseType
{
    /**
